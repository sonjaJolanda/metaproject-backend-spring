...
/**
 * A subclass implementation for a metaproject leader change. This is only an
 ...
 */
@Entity
@DiscriminatorValue("MLC")
public class CommMetaprojectLeaderChange extends CommInfoAbstract {
	...
	public CommType getType() {
		return CommType.METAPROJECT_LEADER_CHANGE;
	}
