 ...
 */
@Entity
@DiscriminatorValue("TIW")
public class CommTeamInvitationWithdraw extends CommInfoAbstract {
     ...
     */
    @NotNull(message = "invited is null")
    @ManyToOne
    private User invitedMember;

    public User getInvitedMember() {
        return invitedMember;
    }

    public void setInvitedMember(User invitedMember) {
        this.invitedMember = invitedMember;
    }

    @Override
    public CommType getType() {
        return CommType.TEAM_INVITATION_WITHDRAW;
    }
