...
/**
 * A subclass implementation for a team invitation. This communication request
 * expects an answer.
 * 
 * @author SiKelle
 *
 */
@Entity
@DiscriminatorValue("TIV")
public class CommTeamInvite extends CommAgreeRejectAbstract {
